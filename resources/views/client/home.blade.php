	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
			  <li class="nav-item active"><a href="{{route('clients.home')}}" class="nav-link">Home</a></li>
			  <li class="nav-item active"><a href="{{route('clients.shop')}}" class="nav-link">shop</a></li>
	          
	          <li class="nav-item cta cta-colored"><a href="{{route('clients.cart')}}" class="nav-link"><span class="icon-shopping_cart"></span>[0]</a></li>
